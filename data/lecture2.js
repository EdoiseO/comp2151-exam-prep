...
const categories = [
  ...
  {key: 'princ', label: 'Principles', cls: 'c1'},
  {key: 'aspect', label: 'Aspects', cls: 'c2'},
  {key: 'persona', label: 'Personas', cls: 'c3'},
  {key: 'story', label: 'User Stories', cls: 'c4'},
  {key: 'backlog', label: 'Backlog', cls: 'c5'},
  {key: 'vel', label: 'Velocity', cls: 'c6'},
];
...
window.COMP2151_LECTURES.push({
  ...
  description: '65 deep Q&A questions on Scrum principles, aspects, personas, user stories, backlogs, and velocity.',
  categories,
  questions: lecture2Questions.map(shuffleQuestionOptions)
});
})();
